# Codex Bug Bounty — Plugin Guide

This repo is a Codex CLI plugin for professional bug bounty hunting across HackerOne, Bugcrowd, Intigriti, and Immunefi.

## What is Codex

Codex is OpenAI's coding agent for software development. Use the Codex CLI to run tasks locally in your repository.
...
### Commands (15 command skills)

Each prior slash command is now a Codex skill under `.agents/skills/commands/`.
