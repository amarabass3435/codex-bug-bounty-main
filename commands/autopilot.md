...
**Start a fresh Codex CLI session per target.** Codex accumulates context across a session —
...
For long hunts, run `/compact` (Codex built-in) periodically to compress context
