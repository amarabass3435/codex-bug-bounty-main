...
**Codex Bug Bounty** — Last updated: April 2026

---

## 1. What This Tool Is

Codex Bug Bounty is a free, open-source plugin for Codex CLI that helps security researchers find vulnerabilities in authorized bug bounty programs. It is a tool to assist human hunters — not a replacement for professional judgment.
...
The authors of Codex Bug Bounty provide this software **as-is**, with no warranties of any kind.
